...
import {initTheme} from '../../src/frontend/ui/theme.ts';

describe('Theme Management', () => {
	let mockBtn: {onclick: ((e: object) => void) | null};
	let state: import('../../src/frontend/types.ts').State;
	...
	beforeEach(() => {
		...
		state = {
			charts: {},
		} as unknown as import('../../src/frontend/types.ts').State;
	});
	...
	it('should update chart options when theme changes', () => {
		...
		state.charts.test = mockChart as unknown as import('../../src/frontend/types.ts').ChartInstance;
